...
public class Field {
    ...
    public Field() {
        ...
        i = 1;
        while (i <= 7){
            draughts[1][i] = new Draught(1,i,true,false);
            i = i + 2;
        }
        i = 0;
        while (i <= 7){
            draughts[2][i] = new Draught(2,i,true,false);
            i = i + 2;
        }
        i = 1;
        while (i <= 7){
            draughts[5][i] = new Draught(5,i,false,false);
            i = i + 2;
        }
        i = 0;
        while (i <= 7){
            draughts[6][i] = new Draught(6,i,false,false);
            i = i + 2;
        }
        i = 1;
        while (i <= 7) {
            draughts[7][i] = new Draught(7,i,false,false);
            i = i + 2;
        }
        color = true;
    }
    ...
    public void set_draught(Draught draught){
